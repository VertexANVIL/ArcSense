...
{
    internal class Bme680HumiditySensor : Sensor<Bme680Sensor>, IHumiditySensor
    {
        /// <summary>
        /// Humidity oversampling.
        /// </summary>
        internal Bme680HumidityOversamplings HumidityOversampling = Bme680HumidityOversamplings.x08;
        ...
        public override async Task InitialiseAsync()
        {
            ...
            Driver.Device.Write(new[] { (byte)Bme680Registers.CtrlHumidity, (byte)HumidityOversampling });
            await Task.Delay(1);
        }
